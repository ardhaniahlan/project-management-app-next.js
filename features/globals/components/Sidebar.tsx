...
export function Sidebar({ user }: SidebarProps) {
  ...
  // 1. Tambahkan parameter event (e) bertipe React.FormEvent
const handleLogout = async (e: React.FormEvent) => {
  e.preventDefault(); // 2. WAJIB ADA: Mencegah browser melakukan refresh bawaan form
      ...
      <div>
        <div className="h-16 flex items-center px-6 border-b border-gray-100 mb-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-gray-900 text-lg tracking-tight">Kinetic Logic</span>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  isActive ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'
                }`}
              >
