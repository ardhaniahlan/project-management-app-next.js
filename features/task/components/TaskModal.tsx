...
export function TaskModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/10 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl border border-gray-200 w-full max-w-2xl max-h-[92vh] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
                      ...
                      task.checklists.map((checklist) => (
                        ...
                        >
                          <input
                            ...
                            disabled={isReadOnly}
                            className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-600 disabled:opacity-50 shrink-0"
                          />
                          <span
                            className={`text-sm truncate ${checklist.isCompleted ? "text-gray-400 line-through" : "text-gray-700"}`}
                          >
                            {checklist.title}
                          </span>
                  ...
                  {userRole !== "member" && !isReadOnly && (
                    <div className="mt-3 flex gap-2">
                      <input
                        ...
                        className="flex-1 min-w-0 px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent disabled:bg-gray-50"
                      />
                      <button
                        onClick={handleAddChecklist}
                        disabled={!newChecklist.trim() || isLoadingChecklist}
                        className="px-3 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm font-medium whitespace-nowrap shrink-0"
                      >
                        {isLoadingChecklist ? "..." : "Tambah"}
                      </button>
                    </div>
                  )}
                </div>
                  ...
                  >
                    ...
                    <div className="flex-1 flex gap-2">
                      <input
                        ...
                        className="flex-1 min-w-0 px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:bg-white transition-colors"
                      />
                      <button
                        type="submit"
                        disabled={!newComment.trim() || isSubmittingComment}
                        className="px-3 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 transition-colors flex items-center gap-1.5 text-sm font-medium shrink-0"
                      >
                        {isSubmittingComment ? (
                          "..."
                        ) : (
            ...
            <div className="p-6 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="grid grid-cols-2 gap-4 items-start">
                <div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-3 h-40 overflow-y-auto space-y-2">
                    {members.length === 0 && (
                ...
                {mode === "create" && (
                  <div>
                    ...
                    <div className="bg-gray-50/50 border border-gray-200 border-dashed rounded-lg p-3 h-40 flex flex-col">
                      {pendingChecklists.length > 0 && (
                        <div className="space-y-2 mb-2 overflow-y-auto flex-1">
                          {pendingChecklists.map((item, idx) => (
                            <div
                              key={idx}
                              className="flex justify-between items-center bg-white border border-gray-200 px-2.5 py-1.5 rounded-md text-sm"
                            >
                      ...
                      <div className="flex gap-2 mt-auto">
                        <input
                          ...
                          className="flex-1 min-w-0 px-2.5 py-1.5 text-sm bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600"
                        />
                        <button
                          type="button"
                          ...
                          className="px-2.5 py-1.5 bg-indigo-100 text-indigo-700 font-medium text-sm rounded-md hover:bg-indigo-200 disabled:opacity-50 transition-colors shrink-0"
                        >
                          <Plus size={14} />
                        </button>
                      </div>
